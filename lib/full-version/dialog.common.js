...
function setEnvironment(_ref) {
  var Promise = _ref.Promise,
      dialogPolyfill = _ref.dialogPolyfill;
...
var forEach$1 = forEach || function forEach(iteratee) {
  var i = 0;
...
var assign$1 = assign || function assign(target) {
...
var globalThis$1 = Function('return this')();
...
var NS = 'fu';
var BLOCK = "".concat(NS, "-dialog");
var CONTAINER = BLOCK;
var HEAD = "".concat(BLOCK, "__head");
var TITLE = "".concat(BLOCK, "__title");
var BODY = "".concat(BLOCK, "__body");
var MESSAGE = "".concat(BLOCK, "__message");
var MESSAGE_BODY = "".concat(BLOCK, "__message-body");
var INPUT = "".concat(BLOCK, "__input");
var FOOT = "".concat(BLOCK, "__foot");
var ACTIONS = "".concat(BLOCK, "__actions");
var CLOSE_BTN = "".concat(BLOCK, "__close");
var ACTION = "".concat(BLOCK, "__action");
var ACTION_TYPE_CONFIRM = "".concat(ACTION, "--confirm");
var ACTION_TYPE_CANCEL = "".concat(ACTION, "--cancel");
var DIALOG_TYPE_ALERT = "".concat(BLOCK, "--alert");
var DIALOG_TYPE_CONFIRM = "".concat(BLOCK, "--confirm");
var DIALOG_TYPE_PROMPT = "".concat(BLOCK, "--prompt");
...
var isArray$1 = isArray || function isArray(x) {
...
function parseDomProperties() {
  var properties = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  if (isArray$1(properties) || typeof properties === 'string') {
    properties = {
      className: properties
    };
  }

  var classList = parseClassNames(properties.className);
...
function setDefaultProperties(properties, tagName) {
  var defaultProps = defaultDomProperties[tagName];

  if (defaultProps) {
    properties = assign$1({}, defaultProps, properties);
  }
...
function parseOptions(options) {
  var defaultOptions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaults;
...
function createAction(actionText, properties) {
  var action = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : noop;
  ...
  var element = createElement('button', properties);
  return {
    el: element,
    action: action
  };
...
function createTypedAction(type) {
  ...
  return function (actionText, action) {
    var DEFAULT_TEXT = defaults["".concat(type, "ActionText")];
    ...
    return createAction(actionText, {
...
function registerDialog(dialog) {
  var _environment$dialogPo = environment.dialogPolyfill,
      dialogPolyfill = _environment$dialogPo === void 0 ? {} : _environment$dialogPo;
...
function () {
  function Dialog(options, open) {
    ...
    var hasTitle = !(options.title === null || options.title === false || typeof options.title === 'undefined');
    ...
    var _options = options,
        ...
        closeButtonText = _options$closeButton === void 0 ? '' : _options$closeButton,
...
function shortcutWrapper(method) {
  return function shortcutWrapper(options) {
    var onAction = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : noop;
    var Promise = environment.Promise;
    var dialog;
...
function alert(options) {
  ...
  if (!options.actions) {
    var confirmButton = createConfirmAction(onAction);
...
function confirm(options) {
  ...
  if (!options.actions) {
    var confirmButton = createConfirmAction(onConfirm);
    var cancelButton = createCancelAction(onCancel);
