...
;(function(global, factory) {
  ...
  const es6Promise = createCommonjsModule(function(module, exports) {
    /*!
    ...
    ;(function(global, factory) {
      ...
      function useMessageChannel() {
        ...
        channel.port1.addEventListener('message', flush)
        return function() {
      ...
      function attemptVertx() {
        try {
          const vertx = new Function('return this')().require('vertx')
      ...
      function polyfill() {
        ...
        if (typeof commonjsGlobal !== 'undefined') {
          ...
          try {
            local = new Function('return this')()
          } catch (error) {
            throw new Error(
  ...
  const dialogPolyfill = createCommonjsModule(function(module) {
    ;(function() {
      ...
      function createsStackingContext(el) {
        while (el && el !== document.body) {
          ...
          const invalid = function invalid(k, ok) {
      ...
      function dialogPolyfillInfo(dialog) {
        ...
        if ('MutationObserver' in window) {
          ...
          const delayModel = function delayModel(ev) {
            if (ev.target !== dialog) {
              return
      ...
      dialogPolyfill.isInlinePositionSetByStylesheet = function(element) {
        for (let i = 0; i < document.styleSheets.length; ++i) {
          ...
          let cssRules = null // Some browsers throw on cssRules.
          ...
          for (let j = 0; j < cssRules.length; ++j) {
            ...
            let selectedNodes = null // Ignore errors on invalid selector texts.
      ...
      dialogPolyfill.DialogManager = function() {
        ...
        const checkDOM = this.checkDOM_.bind(this) // The overlay is used to simulate how a modal dialog blocks the document.
      ...
      if (window.HTMLDialogElement === undefined) {
        ...
        const replacementFormSubmit = function replacementFormSubmit() {
          if (!isFormMethodDialog(this)) {
  ...
  const div = document$1.createElement('div')
  ...
  const addClass = SUPPORTS_CLASS_LIST
    ? addClassByClassList
    : addClassByClassName
  ...
  const fullVersion = exportModule()
