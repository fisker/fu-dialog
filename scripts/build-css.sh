...
# full-version
sass src/styles/full-version.scss .cache/full-version.css --output-style expanded --source-map .cache
...
# pure-version
sass src/styles/pure-version.scss .cache/pure-version.css --output-style expanded --source-map .cache
